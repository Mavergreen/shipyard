...
# spec: .github/actions/install/action.yml -- the other half of the same design: a consumer gets the
#       PKG at the ref it pinned, and only shipyard itself builds from source.
